...
#       - Library Loading                                                      #
#                                                                              #
#    2. ClinVar Data Loading (~line 135)                                       #
#       - Load ClinVar data from pre-built cache (see svv_build_cache.R)       #
#                                                                              #
#    3. Data Structures, Helpers & Coordinate Mapping (~lines 165-523)         #
...
#                                                                              #
#    4. Data Loading & Preprocessing (~line 527)                               #
...
variant_data <- read.csv("data/Endicott 2026_citizen_variants.csv", stringsAsFactors = FALSE)


curesyngap1_counts <- tryCatch({
  raw <- read.csv("data/curesyngap1_variants.csv", stringsAsFactors = FALSE)
  table(raw$variant)
}, error = function(e) {
  warning(
...
#                                        ├─ Aggregate counts → Merge → Parse → Coordinate Mapping → Display
